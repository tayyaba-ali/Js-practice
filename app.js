...
// // // // // for (let indexKey of Object.keys(obj)) {
...
// // // // const array = [];
// // // // // const mutltiply = (num, index) => {
// // // // //     console.log(num, index);
// // // // //     array.push(num*2)
// // // // // };

// // // // // for (let i = 0; i < numbers.length; i++) {
// // // // // 	mutltiply(numbers[i], i);
// // // // // }
// // // // // console.log(array);
...
// // // // // }
// // // // // console.log({id:"12"}[Symbol.iterator]);

// // // // // const obj = {
// // // // //     id: 1,
// // // // //     userName: "Tayyaba",
// // // // //     userAddress : 'home is empty'
// // // // // }

// // // // // let [[, value], [, value2], [, value3]] = Object.entries(obj);
// // // // // console.log(value , value2 ,value3);

// // // // // const numbers = [ 1, 2, 34 ]

// // // // // numbers.forEach((num,i,arr)=> console.log(num)
// // // // //  )
...
// // // // // const numbers = [2, 3, 2,0, 2, 2, 4, 5, 4, 6,10];
...
// // // // const numbers = [1,1,2,3,4,2,2,2,2,2,2];
...
// // // // 	if (countMap[num] > 1) {
// // // // 		console.log(`key : ${num} : value ${countMap[num]}`);
// // // // 		duplicatedArray.push(num);
// // // // 	}
// // // // }
// // // // console.log(duplicatedArray);

// // // // let highest = duplicatedArray[0];
// // // // for (let num of duplicatedArray) {
// // // // 	if (num > highest) {
// // // // 		highest = num;
// // // // 	}
// // // // }
...
// // // // // console.log(
// // // // // 	numbers.filter((num, indexNu, arr) => {
// // // // // 		if (arr.indexOf(num) !== indexNu) {
// // // // // 			return num;
// // // // // 		}
// // // // // 	}),
// // // // // );
...
// // // // const userCart = [
// // // //     {product1:1,productName:"mobile",price:12000},
// // // //     {product1:2,productName:"tv",price:18000},
// // // //     {product1:3,productName:"camera",price:34000},
// // // // ]
// // // // console.log(
// // // // 	userCart.reduce((totalPrice, { price }) => {
// // // // 		return totalPrice + price;
// // // // 	}, 0),
// // // // );

// // // // console.log("A".charCodeAt());
// // // // const numbers = [ 10, 3, 2,12,3,1 ]
...
// // // // const getTwoNumbers = (num1, num2, callback) => {
...
// // // // 	return num1 + num2;
// // // // };
// // // // console.log(getTwoNumbers(1, 2, sumNumbers));
...
// // // // const changeElem = (elem, color, text, time, onSuccess, onFailure) => {
// // // // 	setTimeout(() => {
// // // // 		if (elem) {
...
// // // // 	1000,
// // // // 	() => {
// // // // 		changeElem(heading2, 'red', 'Hello World', 2000, () => {
// // // // 			changeElem(
// // // // 				heading3,
// // // // 				'red',
// // // // 				'Hello World',
...
// // // // 										6000,
// // // // 										() => {
// // // // 											console.log('All elements have been changed');
// // // // 										},
// // // // 										() => {
// // // // 											console.log('Element 6 not found');
// // // // 										},
// // // // 									);
// // // // 								},
// // // // 								() => {
// // // // 									console.log('Element 5 not found');
// // // // 								},
// // // // 							);
// // // // 						},
// // // // 						() => {
// // // // 							console.log('Element 4 not found');
// // // // 						},
// // // // 					);
// // // // 				},
// // // // 				() => {
...
// // // const changeText = (elem, text, color, time, onSuccess, onFailure) => {
// // // 	if (elem) {
// // // 		setTimeout(() => {
// // // 			elem.textContent = text;
// // // 			elem.style.color = color;
...
// // const ricePromise = () => {
// // 	const bucket = ['vegetables', 'rice', 'salt', 'chips'];
// // 	return new Promise((resolve, reject) => {
// // 		setTimeout(() => {
// // 			if (bucket.includes('rice') && bucket.includes('salt')) {
// // 				resolve('bngae chawal');
// // 			} else {
// // 				reject('saman kam tha');
// // 			}
// // 		});
// // 	},5000);
// // };
...
// // 	},
// // 	(sikhayat) => {
// // 		console.log(sikhayat);
// // 	},
// // );

// // setTimeout(() => {
// // 	console.log('hi from the setTimeout');
// // }, 0);
...
// // const val = Promise.resolve('tldhsd');
// // val.then((val) => {
// // 	val = 'tayyaba';
// // 	return val;
// // }).then(final => {
...
// 	let res = await fetch('https://ai.escuelajs.co/api/v1/products')
// 		.then((res) => res.json())
...
// document.write("4 X " + counter + "=" + 4 * counter+"<br />")
// counter++
// document.write('4 X ' + counter + '=' + 4 * counter + '<br />');
// counter++;
// document.write('4 X ' + counter + '=' + 4 * counter + '<br />');
